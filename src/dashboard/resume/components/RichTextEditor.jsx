...
const PROMPT =
  'Position Title: {positionTitle} Campany: {campany}, Depends on Position title and Campany give me list of summary for 3 list summary levels, Beginner Level Pro Level and Advance level in 3-4 lines in array format, With summary and position_level Field in JSON Format';
...
const RichTextEditor = ({ onRichTextEditorChange, index, defaultValue }) => {
  ...
  const GenerateSummaryFromAI = async () => {
    ...
    const campany = resumeInfo?.Experience[index]?.campanyName;
    const prompt = PROMPT.replace('{positionTitle}', positionTitle).replace('{campany}', campany);
